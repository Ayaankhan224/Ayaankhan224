...
# ===========================================================================
HOST = "Ayaankhan224"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Name", "Ayaan Khan"),
    ("kv", "Focus", "Building intelligent software"),
    ("kv", "Mode", "Projects, product thinking, clean UI"),
    ("kv", "Site", "portfolio-wheat-six-ebo4wwgi5a.vercel.app"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Node, APIs, databases"),
    ("kv", "AI / ML", "LLMs, automation, smart workflows"),
    ("kv", "Cloud", "Vercel, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Turning ideas into shipped projects"),
    ("bul", "Learning fast and building in public"),
]
